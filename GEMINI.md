# Gemini Instructions: FFC-Static-Site-Capture-Tools

Hey Gemini! Welcome to FFC-Static-Site-Capture-Tools.
...
The site deploys to `https://freeforcharity.github.io/FFC-Static-Site-Capture-Tools/` (and your custom domain if configured). The `assetPath()` function from `src/lib/assetPath.ts` handles this automatically.
